...
Pod::Spec.new do |s|
  s.name             = 'MyKeyboard'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MyKeyboard.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangwenfeng [张文锋]/MyKeyboard'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangwenfeng [张文锋]' => 'zhangwenfeng@xiaomi.com' }
  s.source           = { :git => 'https://github.com/zhangwenfeng [张文锋]/MyKeyboard.git', :tag => s.version.to_s }
